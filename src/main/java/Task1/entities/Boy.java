...
public class Boy {
    ...
    public Boy(final int x, final int y, final int width, final int height, final Color clothesColor) {
        this.x = x / 5;
        this.y = y / 5;
    ...
    protected void drawHead(Graphics2D g2d) {
        ...
        g2d.drawOval(x + (int) (BACKGROUND_WIDTH / 3.2), y + BACKGROUND_HEIGHT / 16, (int) (BACKGROUND_WIDTH / 2.6), (int) (BACKGROUND_HEIGHT / 2.6));
    }
    ...
    protected void drawEye(Graphics2D g2d, int x, int y) {
        ...
        g2d.setColor(Color.BLACK);
        g2d.drawOval(x, y, BACKGROUND_WIDTH / 10, BACKGROUND_WIDTH / 10);

        g2d.setColor(Color.BLUE);
        g2d.fillOval(x + BACKGROUND_WIDTH / 40, y + BACKGROUND_WIDTH / 40, BACKGROUND_WIDTH / 20, BACKGROUND_WIDTH / 20);
        g2d.setColor(Color.GRAY);
        g2d.drawOval(x + BACKGROUND_WIDTH / 40, y + BACKGROUND_WIDTH / 40, BACKGROUND_WIDTH / 20, BACKGROUND_WIDTH / 20);
