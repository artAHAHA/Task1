...
import com.example.demo2.algorithms.WuAlgorithm;
...
public class Application extends javafx.application.Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Button drawDDAButton = new Button("DDA");
        Button drawBresenhamButton = new Button("Bresenham");
        Button drawWuButton = new Button("Wu");
        ...
        inputGrid.add(drawDDAButton, 1, 3, 2, 1);
        inputGrid.add(drawBresenhamButton, 3, 3, 2, 1);
        inputGrid.add(drawWuButton, 5, 3, 2, 1);
        inputGrid.add(clearButton, 1, 5, 2, 1);


        drawDDAButton.setOnAction(e -> {
            try {
                ...
                DDA_Algorithm.drawLine(gc, x1, y1, x2, y2, color1, color2);
        ...
        drawWuButton.setOnAction(e -> {
            try {
                ...
                WuAlgorithm.drawLine(gc, x1, y1, x2, y2, color1, color2);
            } catch (NumberFormatException ex) {
                System.out.println("Неверный формат координат. Введите целые числа.");
            }
        });
